$(document).ready(function() {
	...
	$.fn.calendar({
		textNavigationMonths: ['<img src="assets/img/flags/CAL_IMG_navigation_previous.png" alt="'+calendarLocale[languageSetting]['navigationMonths'][0]+': " />','<img src="assets/img/flags/CAL_IMG_navigation_next.png" alt="'+calendarLocale[languageSetting]['navigationMonths'][1]+': " />']
		...
		while (countCalendarDay<totalCalendarDays) {
			...
			if (countPreviousMonthDay>0 || countMonthDay>=numberOfDays) { // Previous and next months' days
				...
				if(fechacalendar>=fechahoyceros){
					tagLink.attr({'href':'?r=servicios/mapa&fecha='+fechacalendar+'','data-date':''+year+'-'+textMonth+'-'+textDay+''});		
				}
