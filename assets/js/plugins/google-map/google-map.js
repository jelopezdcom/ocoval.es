	...
	function loadScript() {
		...
		script.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyALqyBI0kI_yHozThfSciGmc_zFc76Pl60&sensor=true&' +
			'callback=initialize';
	...
	function codeAddress(theMap) {
		...
		var address = "Avinguda del Cardenal Benlloch, 75 46021 València Valencia";
